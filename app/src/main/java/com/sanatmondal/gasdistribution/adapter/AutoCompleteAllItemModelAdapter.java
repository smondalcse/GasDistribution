...
public class AutoCompleteAllItemModelAdapter extends ArrayAdapter<ItemModel> {
    private static final String TAG = "AutoComBikeAdapter";

    private List<ItemModel> ItemModelListFull;

    public AutoCompleteAllItemModelAdapter(@NonNull Context context, @NonNull List<ItemModel> BikeList) {
